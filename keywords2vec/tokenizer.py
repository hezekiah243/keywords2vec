...
def prepare_stopwords(stopwords=None, additional_stopwords=None, lang="en"):
    if os.environ.get("TOKENIZER_LANG"):
        lang = os.environ.get("TOKENIZER_LANG")
...
def tokenize(text, text_output=False, lang="en"):
    if os.environ.get("TOKENIZER_LANG"):
        lang = os.environ.get("TOKENIZER_LANG")
